classdef CustomFFT2PropagationLayer < nnet.layer.Layer %  & nnet.layer.Acceleratable 
    ...
    methods
        function layer = CustomFFT2PropagationLayer(Name, Nx, Ny, nx, ny, d, wv)
